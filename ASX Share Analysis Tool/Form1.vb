...
Public Class Form1
    ...
    Private Sub tabPreferences_Click(sender As Object, e As EventArgs) Handles tabPreferences.Click
        txtDfltFilePath.Text = System.Configuration.ConfigurationManager.AppSettings("DirectoryPath")
    End Sub
End Class
